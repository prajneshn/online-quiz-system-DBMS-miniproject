...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="background-color: #35549b;height: auto;color:#fff !important">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#35549b;position:fixed;">
        ...
        <center><section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;">Welcome to Online quiz System&nbsp;<?php echo $dbname ?></section></center>
        ...
        <section class="prof" id="prof" style="display: none;color:#35549b;">
        ...
        <section style="color:#fff !important">
            ...
            {  
                ...
                echo "<table id=\"le\"><thead><tr><td>Quiz Title</td>&nbsp;<td>Student name</td><td>score obtained</td><td>Max Score</td><td>Rank</tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {  
                    $rows++;
