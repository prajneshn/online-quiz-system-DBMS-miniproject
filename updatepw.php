...
<style>
    ...
    button:hover {
        background-color: #35549b !important;
    }
...
<body style="margin:0;height: 100%;outline: none;">
    <div class="bg" style="font-weight: bolder;background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
