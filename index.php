...
<body style="margin:0;height: 100%;outline:none;color: #35549bf !important;padding-botton:5vw">
    <div class="bg" style="font-weight: bolder;background-image: url(./quiz5.jpg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: 100%;">
        <center>
            <h1 class="w3-container" style=" color:#35549b;text-transform: uppercase;width: auto;
    background: #00070ef2;padding: 1vw;margin: 0;">ONLINE
                QUIZ System</h1>
        </center>
        <center>
            <div class="w3" class="login" style="width: 40vw;border: 0px solid black;padding: 2vw;font-weight: bolder;margin-top: 10vh;border-radius: 10px;">
                <form method="POST">
                    <div class="seluser">
