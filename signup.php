...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #35549b !important">
    <div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
            <h1 style="text-transform: uppercase;padding: 2vw;background-color: #fff;color: #35549b;margin-top:0;">ONLINE
                QUIZ System</h1>
        </center>
        <div class="seluser">
