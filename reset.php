...
<?php global $message;?>
<body style="margin:0;height: 100%;outline: none;color: #35549b !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/rakesh.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
            <h1 style=" color:#35549b;text-transform: uppercase;width: auto;background:#fff;padding: 1vw;">ONLINE
        ...
        if ($password === $cpassword) {
            ...
            if ($res == true) {
                ...
                if ($dbmail === $username) {
                    ...
                    $mail->Body = '<center><div style="width:100%;background-color:#35549b;color: #fff;height:auto; "><h1>Hello ' . $dbname . '<br></h1><br>here is your security code to reset the password <h1>' . $otp . '</h1><br>  don\'t share security code with any one. <br><br><br>Thank You<br>Online Examination System<br><br><a href="mailto:osesvit2021@gmail.com">Contact Us</a></div></center>';
                    if (!$mail->send()) {
